    ...
    return (
        ...
        <div style={{ width: 300, margin: 'auto', position: 'relative' }}>
            ...
            <GoogleLogin
                ...
                render={renderProps => (
                    <button style={{display:'flex', alignItems:'center', width:220, border:0, boxShadow:'0 1px 6px #bbb', justifyContent:'center', padding:5, margin:'auto',marginBottom:20,backgroundColor:'#fff',borderRadius:4 }} onClick={renderProps.onClick} disabled={renderProps.disabled}>
