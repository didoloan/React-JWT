...
import { useDispatch, useSelector, connect, dispatch } from 'react-redux';
    ...
    return (
        ...
        <div style={{ width: 300, margin: 'auto', position: 'relative' }}>
            ...
            <GoogleLogin
                ...
                render={renderProps => (
                    <button style={{display:'flex', width:220, justifyContent:'center', padding:5, margin:'auto',marginBottom:20, }} onClick={renderProps.onClick} disabled={renderProps.disabled}>
                        <div>
